...
export function Header() {
  ...
  const links=[["ראשי","/#home"],["על התוכנית","/about"],["השיעורים","/#lessons"]];
...
export function LessonCard({lesson,index}:{lesson:Lesson;index?:number}) {
  const lessonHref=lesson.slug==="identity-and-belonging"?`/lessons/${lesson.slug}`:`/lessons/${lesson.slug}.html`;
