  ...
  return <><Header/><main>
    ...
    <section id="about" className="about-section">
      <div className="about-intro">
        ...
        <a href="/about" style={{display:"inline-flex",alignItems:"center",marginTop:"24px",padding:"11px 19px",border:"1px solid #bfd2d2",borderRadius:"999px",color:"var(--deep)",background:"#fff",fontWeight:700,fontSize:".94rem"}}>לעמוד אודות התוכנית ←</a>
      </div>
